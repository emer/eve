...
type View struct {
	World *vpe.Group  `desc:"the root Group node of the virtual world"`
...
func NewView(world *vpe.Group, viewGp *gi3d.Group) *View {
...
func (vw *View) SyncNode(wn vpe.Node, vn gi3d.Node3D, sc *gi3d.Scene) bool {
	nm := wn.UniqueName()
...
func (vw *View) ConfigView(wn vpe.Node, vn gi3d.Node3D, sc *gi3d.Scene) {
	wb := wn.AsNodeBase()
	vb := vn.AsNode3D()
