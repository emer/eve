...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Prjn", &gti.Field{Name: "Prjn", Type: "goki.dev/mat32.Mat4", LocalType: "mat32.Mat4", Doc: "projection matrix for converting 3D to 2D -- resulting X, Y coordinates are used from Vec3", Directives: gti.Directives{}, Tag: ""}},
